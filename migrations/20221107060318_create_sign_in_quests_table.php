...
class CreateSignInQuestsTable extends AbstractMigration
{
    private $tableName = 'sign_in_quests';
    ...
    public function up()
    {
        ...
        $table->addColumn('id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'signed' => false, 'identity' => true])
            ...
            ->addColumn('day', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'signed' => false, 'default' => 0, 'comment' => '第幾天'])
