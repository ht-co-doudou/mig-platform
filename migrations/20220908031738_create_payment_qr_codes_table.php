...
class CreatePaymentQrCodesTable extends AbstractMigration
{
    private $tableName = 'payment_qr_codes';
    ...
    public function up()
    {
        ...
        $table->addColumn('payment_rank_id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'signed' => false, 'comment' => 'mapping payment_ranks.id'])
            ...
            ->addColumn('channel', 'integer', ['limit' => MysqlAdapter::INT_TINY, 'signed' => false, 'comment' => 'QR Code 支付通道 FourthParty/QrCode/Channel'])
            ->save();
