...
class CreateVideoPlanOrdersTable extends AbstractMigration
{
    private $tableName = 'video_plan_orders';
    ...
    public function up()
    {
        ...
        $table->addColumn('id', 'integer', ['limit' => MysqlAdapter::INT_BIG, 'signed' => false, 'identity' => true])
            ...
            ->addColumn('video_plan_id', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'signed' => false, 'comment' => 'mapping video_plans.id'])
            ->addColumn('type', 'integer', ['limit' => MysqlAdapter::INT_REGULAR, 'signed' => false, 'comment' => '販售幣別 VideoPlan/Type'])
